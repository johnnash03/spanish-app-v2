//! LEGACY (v1) — quarantined in S1 (#32). V1 session queue, attempt
//! submission, and single-prompt LLM evaluation. Replaced by S6: Tier 0
//! evaluation + rebuilt session loop (#37) and S7: Tier 1 decomposed
//! evaluator + error enum (#38). Do not extend. Deleted in S17 (#48).
...
pub fn get_pending_session(
    state: tauri::State<'_, crate::legacy::db::Db>,
