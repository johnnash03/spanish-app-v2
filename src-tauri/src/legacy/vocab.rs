//! LEGACY (v1) — quarantined in S1 (#32). V1 vocabulary intake and pipeline
//! states. Replaced by S10: Words track — bank, intake, window states (#41)
//! and S11: window scheduling + graduation (#42).
