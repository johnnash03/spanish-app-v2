//! LEGACY (v1) — quarantined in S1 (#32). SM-2 flashcard SRS. Removed in v2
//! with no direct counterpart: vocabulary review happens exclusively through
//! exercise scheduling (S11: window scheduling + graduation, #42).
//! Do not extend. Deleted in S17 (#48).
