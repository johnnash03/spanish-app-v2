//! LEGACY (v1) — quarantined in S1 (#32). The v1 database (`spanish-app.db`),
//! schema and seeds. Replaced by the v2 database (`crate::v2::db`,
//! `spanish-app-v2.db`); the v2 schema grows slice by slice from S2 (#33).
