//! LEGACY (v1) — quarantined in S1 (#32). V1 unit metadata and unlock
//! logic. Replaced by S2: licensing-set schema + curriculum loader (#33)
//! and S3: curriculum authoring (#34). Do not extend. Deleted in S17 (#48).

use crate::legacy::db::Db;
use crate::legacy::mastery;
use rusqlite::params;
use serde::Serialize;
